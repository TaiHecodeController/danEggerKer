...
- (void)initView {
    ...
    self.ratioView.layer.borderWidth = 1.f;
    self.ratioView.autoresizingMask = UIViewAutoresizingNone;
    self.ratioView.backgroundColor = [UIColor blackColor];
    self.ratioView.alpha = 0.1;
...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = [UIColor colorWithRed:108.0 / 255 green:204.0 / 255 blue:193.0 / 255 alpha:0.5];
    ...
    confirmBtn.backgroundColor = [UIColor colorWithRed:108.0 / 255 green:204.0 / 255 blue:193.0 / 255 alpha:0.5];
