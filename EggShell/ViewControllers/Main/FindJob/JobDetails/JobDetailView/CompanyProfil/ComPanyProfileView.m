...
-(void)createUI
{
    ...
    self.textSize = [self.detailLable.text sizeWithFont:[UIFont systemFontOfSize:14] constrainedToSize:CGSizeMake(WIDETH - 30, 2000)];
    self.detailLable = detailLalbe;
    detailLalbe.font = [UIFont systemFontOfSize:14];
