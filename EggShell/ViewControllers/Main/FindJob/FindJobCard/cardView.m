...
-(void)makeUI
{
    ...
    //公司名称
    self.companyNnameLable = [[UILabel alloc] initWithFrame:CGRectMake(0, 45*MyWideth+90*MyWideth+15*MyWideth+10*MyWideth+19, WIDETH, 16)];
    ...
    for (int i =0; i < 4; i++) {
        ...
        if (i==0) {
            ...
            UIImageView * firstView =[[UIImageView alloc] initWithFrame:CGRectMake(((self.frame.size.width-30*MyWideth)/4.0 -30*MyWideth)/2.0, 22*MyWideth, 30*MyWideth, 44*MyWideth)];
            firstView.image = [UIImage imageNamed:@"工资"];
            [detailView addSubview:firstView];
            //薪水
            self.salaryLable= [[UILabel alloc] initWithFrame:CGRectMake(0, 22*MyWideth+44*MyWideth+14*MyWideth, (self.frame.size.width-30*MyWideth)/4.0, 15*MyWideth)];
        ...
        if (i==1) {
            ...
            UIImageView * secondView =[[UIImageView alloc] initWithFrame:CGRectMake(((self.frame.size.width-34*MyWideth)/4.0 -30*MyWideth)/2.0, 22*MyWideth, 34*MyWideth, 44*MyWideth)];
            secondView.image = [UIImage imageNamed:@"经验"];
            [detailView addSubview:secondView];
            //薪水
            self.workYearLable= [[UILabel alloc] initWithFrame:CGRectMake(0, 22*MyWideth+44*MyWideth+14*MyWideth, (self.frame.size.width-30*MyWideth)/4.0, 15*MyWideth)];
        ...
        if (i==2) {
            ...
            UIImageView * threeView =[[UIImageView alloc] initWithFrame:CGRectMake(((self.frame.size.width-45*MyWideth)/4.0 -30*MyWideth)/2.0, 22*MyWideth,45*MyWideth, 44*MyWideth)];
            threeView.image = [UIImage imageNamed:@"学历"];
            [detailView addSubview:threeView];
            //薪水
            self.educationalLable= [[UILabel alloc] initWithFrame:CGRectMake(0, 22*MyWideth+44*MyWideth+14*MyWideth, (self.frame.size.width-30*MyWideth)/4.0, 15*MyWideth)];
        ...
        if (i==3) {
            ...
            UIImageView * fourthView =[[UIImageView alloc] initWithFrame:CGRectMake(((self.frame.size.width-33*MyWideth)/4.0 -30*MyWideth)/2.0, 22*MyWideth, 33*MyWideth, 44*MyWideth)];
            fourthView.image = [UIImage imageNamed:@"地址"];
            [detailView addSubview:fourthView];
            //工作年限
            self.addressLable= [[UILabel alloc] initWithFrame:CGRectMake(0, 22*MyWideth+44*MyWideth+14*MyWideth, (self.frame.size.width-30*MyWideth)/4.0, 15*MyWideth)];
    ...
    for (int i =0; i < 5; i++) {
        UIView * bgView = [[UIView alloc] initWithFrame:CGRectMake(15*MyWideth+85*MyWideth*(i%3)+(self.frame.size.width - 30*MyWideth-85*MyWideth)/2.0*(i%3), (45*MyWideth+90*MyWideth+15*MyWideth+10*MyWideth+19+20*MyWideth+90*MyWideth+15*MyWideth)+27*MyWideth*(i/3)+10*MyWideth, 85*MyWideth, 27*MyWideth)];
        [self addSubview:bgView];
